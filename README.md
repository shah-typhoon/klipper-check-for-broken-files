...
> 
> При паузе принтер слегка опускает стол и переходит в режим ожидания. А при отмене печати отправляет ось Z вниз до "Дома". Если не приподнять стол, то он ударятся об низ принтера.
